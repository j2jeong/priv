...
class Supervision_Train(pl.LightningModule):
    ...
    def forward(self, x):
        ...
        #summary(self.net, input_size=(3, 1024, 1024))
        #print(pytorch_model_summary.summary(self.net(x), torch.zeros(8, 3, 1024, 1024), max_depth=None, show_parent_layers=True, show_input=True))
        #summary(self.net, (8,3,1024,1024))
        #torchsummary.summary(self.net, (3, 1024, 1024))
